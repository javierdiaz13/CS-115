...
def findRunBits(s):
    ...
    avg = sum(listOfRunLengths(s))/len(listOfRunLengths(s))
    temp = math.log(min(7, avg))
...
def compress_test():
    assert compressA('11000000001111001001011') == '01000101100110010110001100110010110'
    assert compressA('00000000') == '011111000001'
    assert compressA('0011010011001') == '0101010010110101001'


def uncompress_test():
    assert uncompressA('01000101100110010110001100110010110') == '11000000001111001001011'
    assert uncompressA('011111000001') == '00000000'
    assert uncompressA('010101001011010100') == '0011010011001'
